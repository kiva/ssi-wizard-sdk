...
const config_constants = {
    ...
    component_map: {
        agency_qr: {
            component: 'preBuilt/AgencyQR',
            props: {},
            dataHelper: '../agents/KivaAgent'
        },
        email_input: {
            component: 'preBuilt/EmailScreen',
            props: {}
        },
        smsotp: {
            component: 'preBuilt/SMSOTPScreen',
            props: {
                phoneIntls,
        ...
        registrationForm: {
            component: 'preBuilt/RegistrationForm',
            props: { phoneIntls }
        },
        webcam: {
            component: 'preBuilt/WebcamCaptureTool',
            props: {}
        },
        issue: {
            component: 'preBuilt/CredentialIssuance',
            props: {
                dependencies: {
        ...
        table: {
            component: 'preBuilt/RegistrationUserTable',
            props: {}
        },
        fpScan: {
            component: 'preBuilt/ScanFingerprintScreen',
            props: {
